...
class ResidualBlock(nn.Module):
    def __init__(self, width):
        ...
        self.drop = nn.Dropout(p=0.5)  # 0.1~0.3 조절
...
class BigDeepMLP(nn.Module):
    def __init__(self, input_size=45, width=4096, depth=16, output_size=45):
        super().__init__()
...
def main():     
    ...
    for bn in ballset_list:
        ...
        model = BigDeepMLP(input_size=45 * win_size, width=256, depth=4, output_size=45).to(device)
        ...
        #     train_dst, 
        #     batch_size = min(len(train_dst), win_size), 
        #     # shuffle = True,
        #     shuffle = False,
        #     # num_workers=1,
        #     drop_last=False
